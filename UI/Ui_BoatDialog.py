...
class Ui_BoatDialog(object):
    def setupUi(self, BoatDialog):
        ...
        self.flay_info.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.lbl_boat_color)
        self.lbl_boat_owner_id = QtWidgets.QLabel(BoatDialog)
        self.lbl_boat_owner_id.setObjectName("lbl_boat_owner_id")
        self.flay_info.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.lbl_boat_owner_id)
        ...
        self.flay_info.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.txt_color)
        self.txt_owner_id = QtWidgets.QLineEdit(BoatDialog)
        self.txt_owner_id.setObjectName("txt_owner_id")
        self.flay_info.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.txt_owner_id)
        ...
        self.flay_info.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.spn_passenger_count)
        self.chb_body_status = QtWidgets.QCheckBox(BoatDialog)
        self.chb_body_status.setObjectName("chb_body_status")
        self.flay_info.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.chb_body_status)
        self.chb_full_fuel = QtWidgets.QCheckBox(BoatDialog)
        self.chb_full_fuel.setObjectName("chb_full_fuel")
        self.flay_info.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.chb_full_fuel)
        self.chb_pedal_status = QtWidgets.QCheckBox(BoatDialog)
        self.chb_pedal_status.setObjectName("chb_pedal_status")
        self.flay_info.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.chb_pedal_status)
        ...
        self.flay_info.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.spn_paddle_count)
